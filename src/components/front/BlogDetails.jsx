...
import { fetchBlogsById, addComment, refetchComments } from '../../api/api';
                ...
                <div className="body">
                    ...
                    <div class="container mt-5 border-left border-right">
                        <div class="d-flex pt-3 pb-2"> 
                            <input type="text" name="text" placeholder="Any Comment" class="form-control" value={comment} onChange={(e) => setComment(e.target.value)}/>
                            <Button type="submit" onClick={() => handleAddComment(comment)}>Add</Button> 
                        </div>
